          ...
          <div className="grid md:grid-cols-4 md:gap-4 py-5 border-t-2 border-gray-300/10 text-black">
            <div className="py-8 px-4 space-y-4">
              <div className="text-2xl flex items-center gap-2 font-bold">
                <p className="">
                  Hamro<span className="text-blue-600">Hotel</span>
                </p>
              </div>
              <p>
                Hamro Hotel is the best  hotel booking website in nepal. Its
                most popular  hotel booking in nepal.
              </p>
