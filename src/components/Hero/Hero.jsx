...
import hero1 from "../../assets/landingpage.png";
    ...
    <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-12 bg-white">
      ...
      <div className="flex-1 text-center md:text-left mb-8 md:mb-0">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-6 font-heading">
          Hamro Hotel Let’s Make Your <br /> Stay Comfortable!
        </h1>

        <p className="text-gray-600 mb-8 max-w-lg">
          Explore a variety of hotels, check room availability, and book with
          confidence for your next stay.
        </p>

        <button className="px-6 py-3 bg-blue-500 text-white font-medium rounded-full hover:bg-orange-700 transition">
          Get Started
        </button>
      </div>
